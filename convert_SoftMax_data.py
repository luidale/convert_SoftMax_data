...
def convert_file():
    ...
    if output_type == 3:
        lib.write.write_output3(experiments,input_types,input_location,var_input_type,output_types,output_location)
...
output_types =["1 - wells","2 - average","3 - wells+average", "4 - average+SD"]
